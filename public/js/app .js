...
async function adminNotes() {
    loading();
    const res = await apiFetch('/api/notes/admin/all');
...
async function updateNoteStatus(id, status) {
    const res = await apiFetch(`/api/notes/admin/${id}/status`, 'PUT', { status });
...
async function deleteNote(id) {
    ...
    const res = await apiFetch(`/api/notes/admin/${id}`, 'DELETE');
...
async function adminComplaints() {
    loading();
    const res = await apiFetch('/api/complaints/admin/all');
    const list = res.complaints || [];
    setContent(`
...
function filterComplaintsAdmin(value, field) {
    ...
    apiFetch('/api/complaints/admin/all?' + params).then(res => {
...
async function updateComplaint(id) {
    ...
    const res = await apiFetch(`/api/complaints/admin/${id}`, 'PUT', { status, admin_note });
...
async function deleteEvent(id) {
    ...
    const res = await apiFetch(`/api/events/admin/${id}`, 'DELETE');
